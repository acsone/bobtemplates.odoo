    ...
    def test_odoo_addon(self):
        ...
        self.assertItemsEqual(
            ...
            [
                ...
                self.addon + '/readme/CONTRIBUTORS.rst',
                self.addon + '/readme/HISTORY.rst',
                self.addon + '/readme/CONFIGURE.rst',
                self.addon + '/readme/ROADMAP.rst',
                self.addon + '/readme/DEVELOP.rst',
                self.addon + '/readme/USAGE.rst',
                self.addon + '/readme/DESCRIPTION.rst',
                self.addon + '/readme/INSTALL.rst',
                self.addon + '/readme/CREDITS.rst',
                self.addon + '/readme',
                self.addon + '/static',
